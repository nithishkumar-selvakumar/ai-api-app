...
- `app.routes.chat_routes`: Exposes the RAG query endpoint and time/datetime endpoints.
...
- Added `GET /api/chat/datetime` endpoint returning current server timestamp.
