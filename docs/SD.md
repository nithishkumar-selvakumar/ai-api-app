...
- `app.routes.chat_routes`: Exposes RAG query, documentation status, and test endpoints.
...
- **Chat Endpoints** (`/api/chat`):
  - `GET /documentation-status`: Returns documentation agent test status response.
  - `GET /test-documentation`: Returns a simple documentation test message.
  - `GET /documentation-test`: Returns a documentation pipeline test message.
